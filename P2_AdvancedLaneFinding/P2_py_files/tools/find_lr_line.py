...
def find_lane_pixels(binary_warped):
    ...
    vertices = np.array([[(imshape[1] * 0.0, imshape[0]*0), (imshape[1] * 0.15, imshape[0]*1.0 ),
                          (imshape[1] * 0.85, imshape[0] * 1.0), (imshape[1] * 1.0, imshape[0]*0.0)]], dtype=np.int32)
...
#    righty = nonzeroy[right_lane_inds]
    ...
    #polygon to half width
    half_w=width/2
    half_fit = [half_w] * height
